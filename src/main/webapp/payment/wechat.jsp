...
<head>
    ...
    <style>
        ...
        .amount { text-align: center; font-size: 36px; color: #07c160; margin: 20px 0; }
        ...
        .btn-pay { width: 100%; padding: 15px; background: #07c160; color: #fff; border: none; border-radius: 4px; font-size: 16px; cursor: pointer; }
